...
import utilis.CaptureScreenshot;
...
*/
    ...
    void getDriverTest() {
        ...
        registerUser(loginPage, contactListPage, faker);

        for (int i = 0; i < 5; i++) {
            createContact(addContactPage, contactListPage, wait, faker, i);
        }
    ...
    public void registerUser(LoginPage loginPage, ContactListPage contactListPage, Faker faker) {
    ...
    public void createContact(AddContactPage addContactPage, ContactListPage contactListPage, WebDriverWait wait, Faker faker, int i) {
...
//shorther test - details in helper method